...
import xmltodict
from alliander_utilities.launch_utils import get_file_path
...
def convert_map() -> None:
    ...
    shutil.copy(
        get_file_path("alliander_gazebo", ["config"], "osm2world.properties"),
...
def create_sfd(lon: float, lat: float) -> None:
    ...
    file_path = get_file_path("alliander_gazebo", ["worlds"], "world.sdf")
